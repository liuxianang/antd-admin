        ...
        <div class="table-operator">
            <a-spin :spinning="loading">
              ...
              <a-tag v-if= "text==1" color="blue">是</a-tag>
                    <a-tag v-if= "text==0" color="red">否</a-tag></span>
                </a-table>
...
<script>
    const columns = [
                    ...
                    {title: '详细地址', dataIndex: 'streetname', key: 'streetname'},
                    {title: '邮编号', dataIndex: 'postcode', key: 'postcode'},
                    {title: '电话', dataIndex: 'tel', key: 'tel'},
                    {title: '默认地址', dataIndex: 'isdefault', key: 'isdefault', scopedSlots: { customRender: 'isdefault' }},
                {
            title: '操作',
            key: 'operation',
            fixed: 'right',
    ...
    const formcolumns = [
                    ...
                    {title: '用户名',type:'input', dataIndex: 'username', key: 'username'},
                    {title: '地址',type:'input', dataIndex: 'streetname', key: 'streetname'},
                    {title: '邮编号',type:'input', dataIndex: 'postcode', key: 'postcode'},
                    {title: '电话',type:'input', dataIndex: 'tel', key: 'tel'},
                    {title: '是否默认地址',type:'input', dataIndex: 'isdefault', key: 'isdefault'},
            ];
    import addForm from '@/components/Form/addForm'
    import editForm from '@/components/Form/editForm'
    import API from '../../api/api_addresslist'
