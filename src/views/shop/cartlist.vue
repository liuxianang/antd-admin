...
<script>
    const columns = [
                    {title: 'cartid', dataIndex: 'cartid', key: 'cartid'},
                    ...
                    {title: 'productprice', dataIndex: 'productprice', key: 'productprice'},
                    {title: 'checked', dataIndex: 'checked', key: 'checked'},
                    {title: 'productnum', dataIndex: 'productnum', key: 'productnum'},
                    {title: 'productimg', dataIndex: 'productimg', key: 'productimg'},
    ...
    const formcolumns = [
                    {title: 'cartid',type:'input', dataIndex: 'cartid', key: 'cartid'},
                    {title: 'userid',type:'input', dataIndex: 'userid', key: 'userid'},
                    {title: 'productid',type:'input', dataIndex: 'productid', key: 'productid'},
                    {title: 'productname',type:'input', dataIndex: 'productname', key: 'productname'},
                    {title: 'productprice',type:'input', dataIndex: 'productprice', key: 'productprice'},
                    {title: 'checked',type:'input', dataIndex: 'checked', key: 'checked'},
                    {title: 'productnum',type:'input', dataIndex: 'productnum', key: 'productnum'},
                    {title: 'productimg',type:'input', dataIndex: 'productimg', key: 'productimg'},
                    {title: 'totalprice',type:'input', dataIndex: 'totalprice', key: 'totalprice'},
            ];
    import addForm from '@/components/Form/addForm'
    import editForm from '@/components/Form/editForm'
    import API from '../../api/api_cartlist'
