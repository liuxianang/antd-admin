...
<script>
    const columns = [
                    {title: '文章id', dataIndex: 'topicId', key: 'topicId'},
                    {title: '文章类型', dataIndex: 'topicType', key: 'topicType'},
                    {title: '内容', dataIndex: 'content', key: 'content'},
                    {title: '发布用户', dataIndex: 'fromUid', key: 'fromUid'},
                    {title: '回复用户', dataIndex: 'toUid', key: 'toUid'},
                {
            title: '操作',
            key: 'operation',
            fixed: 'right',
    ...
    const formcolumns = [
                    {title: '文章id',type:'input', dataIndex: 'topicId', key: 'topicId'},
                    {title: '文章类型',type:'input', dataIndex: 'topicType', key: 'topicType'},
                    {title: '回复内容',type:'input', dataIndex: 'content', key: 'content'},
                    {title: '发布用户',type:'input', dataIndex: 'fromUid', key: 'fromUid'},
                    {title: '回复用户',type:'input', dataIndex: 'toUid', key: 'toUid'},
            ];
